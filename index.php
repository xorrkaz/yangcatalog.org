...
<title>YANG Catalog</title>
	<script defer="defer" src="js/beacon.js"></script><script type="text/javascript">
		/* <![CDATA[ */
...
<meta name="application-name" content="YANG Catalog"><meta name="msapplication-window" content="width=device-width;height=device-height">
...
<div class="hero without-featured-image">
		...
		<article id="post-2" class="post-2 page type-page status-publish hentry">
				...
				<p class="lead">A YANG model catalog and registry that allows users
to find models relevant to their use cases from the large and growing
number of YANG modules being published.</p>
<p>This server is running:</p>
<ul>
<li>A NETCONF and REST (not RESTCONF-compliant yet) server loaded with the YANG module from <a href="https://tools.ietf.org/html/draft-clacla-netmod-model-catalog">draft-clacla-netmod-model-catalog</a>.
...
access. The username is <code>oper</code> and the password is <code>oper</code>.</li>
...
<h2>APIs</h2>
<p>For access to the REST interface using curl, try the following to
receive the content of the organizations subtree from the
<a href="https://raw.githubusercontent.com/xorrkaz/netmod-yang-catalog/master/yang-catalog.yang">yang-catalog.yang</a> module.
Note, the currently supported revision yang-catalog.yang is <b>2017-07-14</b>:</p>
...
<article id="post-3" class="post-3 page type-page status-publish has-post-thumbnail hentry">
	...
	<header class="entry-header"><h1 class="entry-title"><a href="/about.php" rel="bookmark">About</a></h1></header>
	<div class="entry-summary">
		<p>From a high level point of this YANG catalog goal is become a
reference for all YANG modules available in the industry, for both YANG
developers (to search on what exists already) and for operators (to
discover the more mature YANG models to automate services). This YANG
catalog should not only contain pointers to the…</p>
...
<article id="post-6" class="post-6 post type-post status-publish format-standard has-post-thumbnail hentry category-uncategorized">
	...
	<header class="entry-header"><h1 class="entry-title"><a href="/blog.php" rel="bookmark">YANG Catalog Latest Development (IETF 98&nbsp;Hackathon)</a></h1></header>
	<div class="entry-summary">
...
<header class="entry-header"><h1 class="entry-title"><a href="/contribute.php" rel="bookmark">Contribute</a></h1></header>
<div class="entry-summary">
	<p>Here you can find instructions on getting yangcatalog.org code as well as contributing
	module and implementation metadata to the Catalog.</p>
